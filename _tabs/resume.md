...
<div style="width: 100%; height: 800px; border: 1px solid var(--border-color); border-radius: 8px; overflow: hidden; background: var(--bg-color);">
  <iframe 
    ...
    height="100%" 
    style="border: none;">
    <p>Your browser does not support PDF embedding. <a href="/assets/resume.pdf" target="_blank">Click here to download the PDF</a></p>
  </iframe>
</div>
...
<div align="right">
  <div style="margin-bottom: 20px;">
    <a href="/assets/resume.pdf" target="_blank" style="margin: 0 10px; text-decoration: none; color: var(--link-color);">
      <i class="fas fa-external-link-alt" style="font-size: 14px;"></i> View
    </a>
